...
RUN cd / && \
    curl -s -L https://s3.amazonaws.com/modcloth-public-travis-artifacts/artifacts/ruby/docker-build-server/ship-artifacts-to-s3/docker-build-server.tar.bz2 | tar -xjvf - && \
